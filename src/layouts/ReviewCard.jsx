  ...
  return (
    <div className=" w-full md:w-1/3 bg-white border-2 border-lightText md:border-none p-5 rounded-lg shadow-[rgba(0,_0,_0,_0.24)_0px_3px_8px]">
      <div>
        ...
        SpiceSaga has completely transformed my cooking experience! As someone who loves trying new recipes and exploring different cuisines, this platform has become my go-to culinary companion.
        </p>
      </div>
